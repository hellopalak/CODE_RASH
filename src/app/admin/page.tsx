...
export default function AdminDashboard() {
    ...
    // --- Layout ---
    return (
        <div style={{ display: "flex", height: "100vh", backgroundColor: "#212529", color: "#fff", fontFamily: "'Press Start 2P', cursive" }}>
            ...
            <aside style={{
                ...
                <h3 style={{ color: "#F7D51D", marginBottom: "30px", fontSize: "1.2rem", textAlign: "center" }}>CODE RASH<br /><span style={{ fontSize: "0.8rem", color: "#fff" }}>ADMIN</span></h3>
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
                    ...
                    {activeTab === "users" && (
                        <div className="nes-container is-dark with-title">
                            <p className="title">Player Management</p>
                            <div className="nes-table-responsive">
                                <table className="nes-table is-bordered is-dark" style={{ width: "100%" }}>
                                    ...
                                    <tbody>
                                        {users.map(user => (
                                            <tr key={user.id}>
                                                <td style={{ fontSize: "0.6rem" }}>{user.id.substring(0, 8)}...</td>
                                                <td style={{ fontWeight: "bold" }}>{user.name}</td>
                                                <td>Round {user.round}</td>
                                                <td>
                                                    {user.warnings || 0}/3
                                                </td>
                                                <td>
